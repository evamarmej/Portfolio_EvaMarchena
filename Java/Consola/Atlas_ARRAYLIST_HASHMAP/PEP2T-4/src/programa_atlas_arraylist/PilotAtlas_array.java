package programa_atlas_arraylist; //opcion 6 duplica systemout

import java.util.Scanner;
import java.util.InputMismatchException;

public class PilotAtlas_array {

    public static void main (String[]args) throws Exception{
        implatlas_array impla = new implatlas_array();
        boolean salir = false;
        int opcion;
        String pais;
        String capital;
